About orange3-geo-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/orange3-geo-feedstock/blob/main/LICENSE.txt)
...
Development: http://github.com/biolab/orange3-geo
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3148&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/orange3-geo-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `orange3-geo` can be installed with `conda`:
...
```
mamba install orange3-geo
```

It is possible to list all of the versions of `orange3-geo` available on your platform with `conda`:
...
```
mamba search orange3-geo --channel conda-forge
```
...
mamba repoquery search orange3-geo --channel conda-forge

# List packages depending on `orange3-geo`:
mamba repoquery whoneeds orange3-geo --channel conda-forge

# List dependencies of `orange3-geo`:
mamba repoquery depends orange3-geo --channel conda-forge
```
